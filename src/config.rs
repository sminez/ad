...
impl Default for ColorScheme {
    fn default() -> Self {
        ...
        let syntax = [
            ...
            ("character",   Styles { fg: Some(string), bg: Some(bg), bold: true, ..Default::default() }),
            ("comment",     Styles { fg: Some(comment), bg: Some(bg), italic: true, ..Default::default() }),
            ("constant",    Styles { fg: Some(constant), bg: Some(bg), ..Default::default() }),
            ("function",    Styles { fg: Some(function), bg: Some(bg), ..Default::default() }),
            ("keyword",     Styles { fg: Some(keyword), bg: Some(bg), ..Default::default() }),
            ("module",      Styles { fg: Some(module), bg: Some(bg), ..Default::default() }),
            ("punctuation", Styles { fg: Some(punctuation), bg: Some(bg), ..Default::default() }),
            ("string",      Styles { fg: Some(string), bg: Some(bg), ..Default::default() }),
            ("type",        Styles { fg: Some(type_), bg: Some(bg), ..Default::default() }),
            ("variable",    Styles { fg: Some(variable), bg: Some(bg), ..Default::default() }),
        ]
