...
///
/// Implementors should NOT call clamp_for themselves: the buffer is responsible
/// for ensuring that cursors are corrected and always in bounds so calling the
/// method a second time is redundant.
pub trait UpdateDot {
    #[must_use]
